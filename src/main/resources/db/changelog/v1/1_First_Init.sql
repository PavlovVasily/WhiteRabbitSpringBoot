...
INSERT INTO `trustmeenglish`.`roles` (`name`)
VALUES ('USER');
INSERT INTO `trustmeenglish`.`roles` (`name`)
VALUES ('MANAGER');
INSERT INTO `trustmeenglish`.`roles` (`name`)
...
INSERT INTO `trustmeenglish`.`users_roles` (`user_id`, `role_id`)
VALUES ('1', '1');
...
INSERT INTO `trustmeenglish`.`en_words` (meaning)
VALUES ('hello');
INSERT INTO `trustmeenglish`.`ru_words` (meaning)
VALUES ('привет');
INSERT INTO `trustmeenglish`.`cards` (en_word_id, ru_word_id, rating)
VALUES ('1', '1', '1');
